% Victor Z
% UW-Madison, 2020
% example log normal RV in pharma 
...
hold on
plot(expx,expF,'blacko','MarkerFaceColor','white','MarkerEdgeColor','black','MarkerSize',10,'LineWidth',1.2) 
hold on
grid on
...
ylabel('$f(x)$','Interpreter','latex','FontSize',14)
title('')
print -depsc ch2_lognormalpsd.eps
