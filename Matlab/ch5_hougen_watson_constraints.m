...
datar=load('Data/hougenwatson.dat');
X=datar(:,1:3); %partial pressures
y=datar(:,4);   % reaction rate
...
[betahat,resnorm,residual,exitflag,output,lam,jacobian]...
...
grid on
print -depsc ch5_hougen_fit_constraints.eps
