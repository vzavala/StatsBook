...
f1 = sin(2*pi*30*t);                      % low-frequency signal
f2 = sin(2*pi*100*t);                     % high-frequency signal
f = f1+f2;  
...
print -depsc ch6_filter_gauss_fourier.eps
...
print -depsc ch6_filter_gauss_fourier_elim.eps
